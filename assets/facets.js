class FacetFiltersForm extends HTMLElement {
  ...
  onSubmitHandler(event) {
    ...
    if (event.srcElement.className == 'mobile-facets__checkbox') {
      ...
      console.log('sortFilterForms', sortFilterForms)
...
let layoutZone = document.querySelector('.layout-zone-left');
let mobileFilterClose = document.querySelector('.mobile-close-filter.x-close');
let mobileFilterApply = document.querySelector('.mobile-close-filter.apply');

mobileFilters.addEventListener('click', function() {  
  layoutZone.classList.add('open')
  mobileFilterClose.classList.remove('hidden')
  mobileFilterApply.classList.add('hidden')
});

mobileFilterClose.addEventListener('click', function() {  
  layoutZone.classList.remove('open')
});